...
export class AppserviciosProvider {
  ...
  constructor(
	...
	getMasVendidos(valor){
	console.log("http://www.tricenter.es/AppCatalogo/index.php/masvendidos/"+valor);
  	return new Promise(
  		resolve=>{
  		   	this.http.get("http://www.tricenter.es/AppCatalogo/index.php/masvendidos/"+valor)
  			.map(res=> res.json())
  			.subscribe(
  				data => {
  					resolve(data);
	...
	setSelect(id){
	  	return new Promise(
	  		resolve=>{
	  			this.http.get("http://www.tricenter.es/AppCatalogo/usuario.php/sel/"+id+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
...
----------------------------------------------------------------*/
	...
	delCesta(codigo, email){
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/cesta.php/delarticulo/"+codigo+"/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
	...
	eddCesta(codigo,  fecha, unidades, email){
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/cesta.php/edd/"+codigo+"/"+fecha+"/"+unidades+"/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
		...
		addCesta(codigo,  fecha, unidades, email){
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/cesta.php/add/"+codigo+"/"+fecha+"/"+unidades+"/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
	...
	obtenernumerocesta(email){
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/cesta.php/obtener/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
	...
	editarcesta(email){
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/cesta.php/editar/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
...
addPedido(data){
    ...
    console.log("Empieza la grabacion " + data["ped_cod"] +  " ");
	  	...
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.put("http://www.tricenter.es/AppCatalogo/pedidos.php/grabarpedido", data)
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
...
getpedidosanteriores(email){
	  	...
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/pedidos.php/editarcab/"+email+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
...
getpedidoanterior(numero){
	  	...
	  	return new Promise(
	  		resolve=>{
	  		   	this.http.get("http://www.tricenter.es/AppCatalogo/pedidos.php/editarlin/"+numero+"/oka")
	  			.map(res=> res.json())
	  			.subscribe(
	  				data => {
	  					resolve(data);
